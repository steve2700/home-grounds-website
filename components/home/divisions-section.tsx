...
import { ArrowRight, Home, Wrench, Building2, Hammer, Shield, Clock, Award, Sparkles } from "lucide-react"
...
export function DivisionsSection() {
  return (
    <section className="relative py-32 bg-white overflow-hidden">
      ...
      <div className="absolute bottom-20 left-0 w-[600px] h-[600px] bg-yellow-100/30 rounded-full blur-[150px]" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 bg-zinc-100 rounded-full px-5 py-2 mb-6">
            ...
            <span className="text-sm font-semibold text-zinc-700 uppercase tracking-wide">What We Do</span>
          </div>
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-zinc-900 mb-6 tracking-tight">
            One Focus,<br />
            <span className="bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-transparent">Exceptional Results</span>
          </h2>
          <p className="text-xl text-zinc-600 max-w-3xl mx-auto leading-relaxed">
            From kitchens and bathrooms to full commercial fit-outs — transforming spaces across Zimbabwe with quality craftsmanship and modern design.
          </p>
        </div>

        {/* Renovations Card — Full Width */}
            ...
            <div className="relative bg-white rounded-3xl overflow-hidden shadow-xl border border-zinc-200/50">
              <div className="grid lg:grid-cols-2">
                ...
                <div className="relative h-80 lg:h-auto overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-zinc-900 via-zinc-900/50 to-transparent lg:bg-gradient-to-r" />
