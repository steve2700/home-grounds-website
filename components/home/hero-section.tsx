...
import { MapPin, ArrowRight, Hammer, CheckCircle2, Award, Users, Clock, Star } from "lucide-react"
...
export function HeroSection() {
  return (
    <section className="relative min-h-[100svh] flex items-center overflow-hidden bg-zinc-950">
      ...
      <div className="absolute bottom-0 -right-48 w-[500px] h-[500px] bg-gradient-to-tl from-amber-600/20 to-yellow-500/10 rounded-full blur-[120px] animate-[pulse_8s_ease-in-out_infinite] [animation-delay:1s]" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-orange-600/10 to-amber-600/10 rounded-full blur-[150px] animate-[pulse_10s_ease-in-out_infinite] [animation-delay:2s]" />
      ...
      <div className="absolute top-4 sm:top-8 left-4 sm:left-8 z-10">
        <div className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-500/15 to-yellow-500/10 backdrop-blur-xl border border-amber-500/30 rounded-xl sm:rounded-2xl px-3 sm:px-6 py-2 sm:py-3 shadow-2xl shadow-amber-500/10">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 pt-20 pb-32 sm:pt-24 sm:pb-24 lg:py-32 z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="text-[2.5rem] leading-[1.1] sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black sm:leading-[0.9] mb-6 sm:mb-8 tracking-tighter">
            ...
            <span className="block bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-300 bg-clip-text text-transparent animate-[fadeInUp_0.6s_ease-out_0.1s_both] [animation:fadeInUp_0.6s_ease-out_0.1s_both,gradient_3s_ease_infinite] bg-[length:200%_auto]">
              Homes.
            </span>
            <span className="block text-white drop-shadow-2xl animate-[fadeInUp_0.6s_ease-out_0.2s_both]">
              Built to
            </span>
            <span className="block bg-gradient-to-r from-amber-500 via-orange-400 to-amber-300 bg-clip-text text-transparent animate-[fadeInUp_0.6s_ease-out_0.3s_both] [animation:fadeInUp_0.6s_ease-out_0.3s_both,gradient_3s_ease_infinite] bg-[length:200%_auto]">
              Last.
            </span>
          </h1>
          ...
          <p className="text-sm sm:text-xl md:text-2xl text-zinc-300 mb-6 sm:mb-12 max-w-3xl leading-relaxed animate-[fadeInUp_0.6s_ease-out_0.4s_both]">
            Zimbabwe's most trusted partner for <strong className="font-bold text-amber-300">quality renovations</strong> — from kitchens and bathrooms to full commercial fit-outs.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-8 sm:mb-16 animate-[fadeInUp_0.6s_ease-out_0.5s_both]">
            ...
            <Link href="/portfolio" className="group relative overflow-hidden rounded-xl sm:rounded-2xl shadow-2xl shadow-white/5 hover:shadow-white/10 transition-all duration-300">
              <div className="absolute inset-0 bg-white/5 backdrop-blur-xl border border-white/20 group-hover:bg-white/10 group-hover:border-white/30 transition-all duration-300" />
