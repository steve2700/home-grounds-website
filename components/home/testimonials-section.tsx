...
const testimonials = [
  ...
  {
    quote: "Our office fit-out was completed ahead of schedule and within budget. The attention to detail was impressive — our staff love the new space.",
  ...
  {
    quote: "The bathroom renovation completely changed how our home feels. High-quality materials, clean workmanship, and a team that genuinely cares about the result.",
    author: "Rudo Ndlovu",
    location: "Bulawayo",
...
export function TestimonialsSection() {
  return (
    <section className="relative py-32 bg-gradient-to-b from-white to-zinc-50 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-gradient-to-tr from-yellow-100/30 to-transparent rounded-full blur-[120px]" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-zinc-600 max-w-3xl mx-auto leading-relaxed mb-8">
            Join over 500 happy clients who trust Home Grounds for their renovation projects
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="group relative">
              {/* Glow Effect */}
              <div className="absolute -inset-0.5 bg-gradient-to-r from-amber-500 to-yellow-500 rounded-3xl blur opacity-20 group-hover:opacity-30 transition-opacity duration-300" />
              ...
              <div className="relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-zinc-200/50 h-full flex flex-col">
                ...
                <div className="absolute top-6 right-6">
                  <div className="bg-amber-50 text-amber-700 border-amber-200 text-xs font-bold uppercase tracking-wide px-3 py-1.5 rounded-full border">
                    Renovation
                  </div>
                </div>
        ...
        <div className="mt-20 text-center">
          <div className="inline-flex flex-col sm:flex-row items-center gap-4 bg-white border border-zinc-200 rounded-2xl p-8 shadow-lg max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a
                href="/quote"
                className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-500 to-yellow-500 text-zinc-900 font-bold px-6 py-3 rounded-xl hover:shadow-lg transition-all duration-300"
              >
                Get a Quote
              </a>
              <a
                href="/contact"
                className="inline-flex items-center justify-center gap-2 border-2 border-amber-500 text-amber-600 font-bold px-6 py-3 rounded-xl hover:bg-amber-50 transition-all duration-300"
              >
                Contact Us
              </a>
            </div>
