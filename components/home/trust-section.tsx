...
const trustPillars = [
  {
    ...
    description: "Years of experience serving Zimbabwe's renovation industry across major cities",
  ...
  },
  {
    ...
    description: "We stand behind every project we deliver — craftsmanship you can count on",
    color: "text-amber-600",
    bgColor: "bg-amber-50",
    borderColor: "border-amber-200",
  },
  {
    ...
    description: "Serving Harare, Bulawayo, Masvingo, Mutare and beyond",
    color: "text-amber-600",
    bgColor: "bg-amber-50",
    borderColor: "border-amber-200",
  },
  {
    ...
    description: "Treating every customer like family with integrity and genuine care",
    color: "text-amber-600",
    bgColor: "bg-amber-50",
    borderColor: "border-amber-200",
  },
...
export function TrustSection() {
  return (
    <section className="relative py-32 bg-gradient-to-b from-zinc-50 to-white overflow-hidden">
      ...
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-yellow-200/20 rounded-full blur-[120px]" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto mb-24">
          {trustPillars.map((pillar, index) => (
            <div key={index} className="group relative">
              {/* Glow Effect */}
              <div className="absolute -inset-0.5 bg-amber-50 rounded-2xl blur opacity-30 group-hover:opacity-50 transition-opacity duration-300" />
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="absolute -inset-1 bg-gradient-to-r from-amber-500 via-orange-500 to-yellow-500 rounded-3xl blur-lg opacity-30" />
            ...
            <div className="relative grid grid-cols-2 lg:grid-cols-4 gap-8 p-12">
              ...
              <div className="text-center group">
                <div className="mb-4">
                  ...
                  <div className="h-1 w-16 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full mx-auto transition-all duration-300 group-hover:w-24" />
                </div>
              ...
              <div className="text-center group">
                <div className="mb-4">
                  <div className="text-5xl md:text-6xl font-black bg-gradient-to-r from-yellow-400 to-amber-400 bg-clip-text text-transparent mb-2">
                    15+
                  </div>
                  <div className="h-1 w-16 bg-gradient-to-r from-yellow-500 to-amber-500 rounded-full mx-auto transition-all duration-300 group-hover:w-24" />
                </div>
              ...
              <div className="text-center group">
                <div className="mb-4">
                  <div className="text-5xl md:text-6xl font-black bg-gradient-to-r from-orange-400 to-amber-400 bg-clip-text text-transparent mb-2">
                    98%
                  </div>
                  <div className="h-1 w-16 bg-gradient-to-r from-orange-500 to-amber-500 rounded-full mx-auto transition-all duration-300 group-hover:w-24" />
                </div>
