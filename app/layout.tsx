...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", locale: "en_ZW", url: "https://homegroundinvestments.co.zw", siteName: "Home Ground Butchery", title: "Home Ground Butchery | Fresh Meat in Chivhu", description: "Farm fresh frozen chicken, turkey, pork and graded beef from Chivhu for homes and the food trade.", images: [{ url: "/images/homeground-butchery-fresh-cut-meat.jpg", width: 1200, height: 800, alt: "Fresh cuts at Home Ground Butchery" }] },
  twitter: { card: "summary_large_image", title: "Home Ground Butchery | Fresh Meat in Chivhu", description: "Farm fresh frozen chicken, turkey, pork and graded beef from Chivhu.", images: ["/images/homeground-butchery-fresh-cut-meat.jpg"] },
  robots: { index: true, follow: true, googleBot: { index: true, follow: true, "max-image-preview": "large", "max-snippet": -1, "max-video-preview": -1 } },
  icons: { icon: "/favicon.ico", apple: "/apple-touch-icon.png" },
  category: "food and agriculture",
}

export const viewport: Viewport = { themeColor: "#1d2b22", width: "device-width", initialScale: 1, userScalable: true }

export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en" className="bg-background"><body className={`${outfit.variable} ${inter.variable} font-sans antialiased`}><OrganizationSchema />{children}<Analytics /></body></html>
}
