      ...
      <main>
        ...
        <section className="bg-sand px-6 py-20 sm:px-10 lg:px-16 lg:py-28">
          <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
            <div className="relative aspect-[4/5] overflow-hidden"><Image src="/images/zimbabwe-farm.jpg" alt="Zimbabwean agricultural land connected to Home Ground Investments" fill sizes="(max-width: 1024px) 100vw, 40vw" className="object-cover" /><div className="absolute bottom-5 right-5 bg-wheat px-4 py-3 text-xs font-bold uppercase tracking-widest text-forest">Home Ground Investments</div></div>
